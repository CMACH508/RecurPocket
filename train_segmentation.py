...
if __name__ == "__main__":
    ...
    from unet_recurrent import coach_test
    ...
    if args.is_cao >= 2:
        model = Unet(iterations=args.iteration, is_seblock=args.is_seblock, is_mask=args.is_mask)
    else:
        model = Unet(iterations=args.iteration)
